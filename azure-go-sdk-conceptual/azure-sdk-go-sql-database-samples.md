...
下表链接到 Go 源代码的选定示例，这些示例可用于使用 Azure SQL 数据库。
...
| [sql/queries](https://github.com/Azure-Samples/azure-sdk-for-go-samples/blob/master/sql/queries.go) | 在 Azure SQL 数据库中创建表、添加行以及查询数据。 |
